...
![A door model](../images/joints.png)
...
![All the frames required to model the door](../images/door-example-frames.png)
...
![Models required for each link and joint in the kinematic chain](../images/door-example-links-joints.png)
...
![Frames and pose modelled to place an object instance in the world](../images/door-example-instance.png)
...
![Screenshot of Gazebo showing the doors positioned inside the entryways](../images/gazebo-screenshot.png)

## How to: Model a state machine and specify intial states

![Finite state machine for a door](../images/doors-example-state-machine.png)
...
![Door states with their joint positions](../images/door-example-joint-positions.png)
